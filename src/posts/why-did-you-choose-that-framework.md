...
The first 3 parts are straightforward without complications or alternatives *( when you want to be a web developer )*. But the framework part is things get complicated, more especially because we have a bunch of options to choose from.
...
As we continue to learn and use our framework of choice, we become more and more confidant. We now tweet about how cool this framework is. As time goes on we become attached to that framework, we begin to defend it, recommend it to others and despise those using alternatives. The fact that other people are still using Jquery is a sign of attachment.
...
The easier path to growth, in my opinion, is to **test things out**, be open to learning new new things, the world of programming is moving rapidly. Don't be left behind.

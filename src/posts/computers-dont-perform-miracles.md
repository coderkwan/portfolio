...
Phrases like _"the computer understands..."_, _"the computer knows..."_, _"the compiler knows..."_ etc. makes it seem like the computer performs miracles. This automatically position the computer in a high level where it seems impossible to understand. This is a huge source of discouragement for individuals who are trying to learn.
...
Yes a computer is complex, some software are complex, but there is nothing divine about the way they function. It is just a bunch of instructions coupled together to perform a specific task.
